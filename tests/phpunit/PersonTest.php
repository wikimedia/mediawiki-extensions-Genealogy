...
class PersonTest extends GenealogyTestCase {
	...
	public function testEmptyDescription() {
		...
		$person = new Person( $this->loadBalancer, $this->wikiPageFactory, Title::newFromText( 'DescTest' ) );
	...
	public function testCreatePerson() {
		...
		$charles = new Person( $this->loadBalancer, $this->wikiPageFactory, $charlesTitle );
		...
		$dianna = new Person( $this->loadBalancer, $this->wikiPageFactory, Title::newFromText( 'Dianna' ) );
		$this->assertSame( [ 'Charles' ], array_keys( $dianna->getPartners() ) );
		$elizabeth = new Person( $this->loadBalancer, $this->wikiPageFactory, Title::newFromText( 'Elizabeth' ) );
	...
	public function testDates() {
		$person = new Person( $this->loadBalancer, $this->wikiPageFactory, Title::newFromText( 'Will' ) );
	...
	public function testRedirectPartner() {
		...
		$diana = new Person( $this->loadBalancer, $this->wikiPageFactory, Title::newFromText( 'Diana' ) );
	...
	public function testGetWikiLink() {
		$person = new Person( $this->loadBalancer, $this->wikiPageFactory, Title::newFromText( 'Alice Example' ) );
